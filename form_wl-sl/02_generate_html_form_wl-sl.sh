...
input_file="pdf_list_form_wl-sl.txt"
output_file="output_form_wl-sl.html"

if [[ ! -f "$input_file" ]] ; then
    echo -e "The file ${RED}pdf_list_form_wl-sl.txt generated from ./01_get_paths_form_wl-sl.sh${NC} was not ran"
    exit 1
fi
