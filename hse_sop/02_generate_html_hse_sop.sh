...
input_file="pdf_list_hse_sop.txt"
output_file="output_hse_sop.html"

if [[ ! -f "$input_file" ]] ; then
    echo -e "The file ${RED}pdf_list_hse_sop.txt generated from ./01_get_paths_hse_sop.sh${NC} was not ran"
    exit 1
fi
