...
rsync -azr --delete "/Volumes/IMS/New Hand Over Folder with Aligenment/01- NEOS IMS Final-2025-Uploaded on Server 20-Oct-25/External Standard & Customer Specification/ROO SOPs for SLK Ops/" \
    "/Volumes/WL-SL/02 Slickline/.IMS/ROO SLS SOP/"

echo -e "${YELLOW}Finished rsync ROO SOP's${NC}"
