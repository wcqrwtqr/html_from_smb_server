...
# to the QHSE server rsync

# Check if the mnt IMS and QHSE
...
rsync -azr --delete "/Volumes/IMS/New Hand Over Folder with Aligenment/01- NEOS IMS Final-2025-Uploaded on Server 20-Oct-25/Level- 4 - Form & Templates/QHSE/pdf-forms/" \
    "/Volumes/WL-SL/02 Slickline/.dot-files/form_qhse/"

echo -e "${YELLOW}Finished rsync QHSE forms's${NC}"
