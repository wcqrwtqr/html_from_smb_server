...
if ! sed -i '' 's|/Volumes/My Passport for Mac/NEOS/Server Backup/WL-SL|..|g' ./output_certificate.html; then
...
echo -e "${MAGENTA}File 'output_certificate.html' processed successfully.${NC}"
